...
@meta:
{
    ...
    "icon": "ph-duotone ph-file-html"
}
---
# Htmler Guide

Welcome to the Finch Htmler Guide! This guide will walk you through the steps to use Htmler in your Finch application. Whether you're a seasoned developer or just starting, Finch offers a robust set of tools to simplify server-side web app development.

## What is Htmler?

Htmler is a simple HTML generator. It is used to generate HTML in a more readable and maintainable way. It is used in Finch to generate HTML for views.

### where to use Htmler?

Htmler can be used in any place that you need to generate HTML. For example, you can use it in your controllers to generate HTML for your views. You can also use it in your views to generate HTML for your templates. by htmler you dont need to use any template engine. you can generate your HTML code directly in your dart code. so it can be useful for small projects or for generating HTML code that you keep the template in your dart code. (for widgets you must move your template to widget files that need to be in separated files in production environment. so for making a single file project htmler is a good choice.)

Here is an example of how use htmler in your project:

### Note: 
    you can add jinja tags in your htmler code. for more clue please refer this class: lib/src/views/htmler.dart `JJ` class is used to add jinja tags in your htmler code.
