...
فینچ از پکیج [sqlite3](https://pub.dev/packages/sqlite3) برای عملیات پایگاه داده SQLite استفاده می‌کند. می‌توانید با استفاده از این پکیج عملیات پایگاه داده را در برنامه فینچ خود انجام دهید.
...
فینچ از پکیج [sqler](https://pub.dev/packages/sqler) برای ساخت کوئری‌های SQL استفاده می‌کند. می‌توانید از این پکیج برای ساخت کوئری‌های پیچیده برای پایگاه داده SQLite خود استفاده کنید.

## مثال

برای اطلاعات بیشتر می‌توانید پروژه [example](https://github.com/uproid/finch/tree/master/example) را در مخزن فینچ مشاهده کنید. این پروژه از پایگاه داده SQLite و امکانات پایگاه داده فینچ استفاده می‌کند.