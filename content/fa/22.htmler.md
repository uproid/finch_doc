...
به راهنمای Htmler فینچ خوش آمدید! این راهنما شما را با مراحل استفاده از Htmler در برنامه فینچ آشنا می‌کند. چه توسعه‌دهنده حرفه‌ای باشید یا تازه‌کار، فینچ مجموعه‌ای قدرتمند از ابزارها را برای ساده‌سازی توسعه وب‌اپلیکیشن سمت سرور ارائه می‌دهد.

## Htmler چیست؟

Htmler یک تولیدکننده ساده HTML است. این ابزار برای تولید HTML به روشی خوانا و قابل نگهداری استفاده می‌شود و در فینچ برای تولید HTML نماها کاربرد دارد.

### کجا از Htmler استفاده کنیم؟

Htmler را می‌توانید در هر جایی که نیاز به تولید HTML دارید استفاده کنید. برای مثال، می‌توانید در کنترلرها برای تولید HTML نماها یا حتی در خود نماها برای تولید قالب HTML استفاده کنید. با Htmler نیازی به استفاده از موتور قالب ندارید و می‌توانید کد HTML را مستقیماً در کد دارت خود تولید کنید. این موضوع برای پروژه‌های کوچک یا تولید HTML که قالب را در کد دارت نگه می‌دارید مفید است. (برای ویجت‌ها باید قالب را به فایل‌های جداگانه منتقل کنید که در محیط تولید توصیه می‌شود. اما برای پروژه‌های تک‌فایلی Htmler انتخاب خوبی است.)

در اینجا مثالی از نحوه استفاده از Htmler در پروژه آورده شده است:

### نکته:
  می‌توانید تگ‌های جینجا را در کد Htmler خود اضافه کنید. برای اطلاعات بیشتر به کلاس lib/src/views/htmler.dart و کلاس `JJ` مراجعه کنید.
