...
### نکته:
  ...
  همچنین می‌توانید قابلیت‌های جدید فینچ را در صفحه دمو مشاهده کنید: [https://example.uproid.com](https://example.uproid.com) که همیشه با آخرین نسخه فینچ به‌روزرسانی می‌شود.
