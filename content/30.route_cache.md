...
Caching stores HTTP responses and replays them for subsequent matching requests, skipping the controller and database entirely. This drastically reduces response time for routes whose output doesn't change on every request.
